...
\begin{itemize}
  ...
  \item Soportar sintaxis con el operador \verb{|} para especificar múltiples producciones en una sola línea.
\end{itemize}
...
\begin{itemize}
  \item \textbf{Editor de gramáticas}.  Permite escribir gramáticas libres de contexto, separando símbolos con espacios y utilizando \verb|ε| o \verb|epsilon| para producciones vacías.  Además, soporta el uso del operador \verb{|} para especificar múltiples alternativas en una sola línea (por ejemplo, \verb{C -> a | b}).
...
Nótese el uso del operador \verb{|} para especificar alternativas en las producciones de B, C y D.
...
\begin{itemize}
  ...
  \item \textbf{Soporte para sintaxis con alternativas}.  El parser reconoce el operador \verb{|} para especificar múltiples producciones en una sola línea, simplificando la escritura de gramáticas.
